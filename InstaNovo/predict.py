...
#########################################################################################################################
    save_df = pd.DataFrame({
        "index": range(len(pred_df)),
        "transformer_predictions": pred_df.get("transformer_predictions", [""] * len(pred_df)),
        "diffusion_predictions": pred_df.get("diffusion_predictions", [""] * len(pred_df)),
        "transformer_log_probabilities": pred_df.get("transformer_log_probabilities", [""] * len(pred_df)),
        "diffusion_log_probabilities": pred_df.get("diffusion_log_probabilities", [""] * len(pred_df)),
        "final_log_probabilities": pred_df.get("final_log_probabilities", [""] * len(pred_df)),
        "final_prediction": pred_df.get("final_prediction", [""] * len(pred_df)),
        "targets":  pred_df.get("targets", [""] * len(pred_df))
    })

    save_df.to_csv("summary_predictions.csv", index=False)
    print("Saved summary_predictions.csv")
########################################################################################################################
